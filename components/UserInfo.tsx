...
const UserInfo: React.FC<Props> = ({ setState, userData, setUserData }) => {
    ...
    return (
        <>
            <div>
                <label htmlFor="name" className="block text-lg font-bold text-gray-300">
                    Nama
                </label>
                <div className="mt-1">
                    <input
            ...
            <div>
                <label htmlFor="age" className="block text-lg font-bold text-gray-300">
                    Umur
                </label>
                <div className="mt-1">
                    <input
            ...
            <div>
                <label htmlFor="gender" className="block text-lg font-bold text-gray-300">
                    Jenis Kelamin
                </label>
                <div className="mt-1">
                    <select
            ...
            <div>
                <button
                    ...
                    className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md text-lg font-bold text-black bg-white hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 disabled:opacity-50"
                >
                    Lanjut
                </button>
            </div>
